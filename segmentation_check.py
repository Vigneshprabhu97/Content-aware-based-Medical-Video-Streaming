...
def ShowImage(title,img,ctype):
  ...
  plt.title(title)
  plt.show()
img           = cv2.imread('frame176.jpg')
gray          = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
ShowImage('Fetal Abnormality Detection',gray,'gray')
